  ...
  return (
    ...
    text-white ${selectedUser ? "max-md:hidden" :''}`}>
        <div className='pb-5'>
            ...
            <div className='bg-[#282142] rounded-full flex items-center gap-2 py-3 p-4 mt-5'>
        ...
        <div className='flex flex-col'>
            {filteredUsers.map((user, index) =>(
                <div key={user._id} onClick={()=>{setSelectedUser(user)}} className={`relative flex items-center gap-2 p-2 pl-4 rounded
